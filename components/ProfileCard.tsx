...
const ProfessorCard = ({ professor, handleViewProfessor }: { professor: Professor, handleViewProfessor: (id: number) => void }) => (
  <div className="bg-purple-600 rounded-lg overflow-hidden shadow-lg p-4">
    ...
    <div className="flex justify-between items-center">
      ...
      <button className="bg-purple-500 hover:bg-purple-400 text-white px-3 py-1 rounded-md transition duration-300 ease-in-out text-sm" onClick={() => handleViewProfessor(professor.id)}>
        View Profile
      </button>
    </div>
  </div>
